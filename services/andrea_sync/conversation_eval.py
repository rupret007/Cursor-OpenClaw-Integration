...
CONVERSATION_CORE_CASES: tuple[ConversationCaseSpec, ...] = (
    ...
    ConversationCaseSpec(
        case_id="personality_feedback_more_voice",
        title="Personality / humor feedback stays conversational (no generic or grounded scaffolding)",
        behavior_family="opinion_reflection",
        turns=(
        ...
        first_message_id=28072,
        required_turn_domains=("opinion_reflection",),
        required_reply_markers=("warmer", "playful"),
        forbidden_reply_markers=(
    ...
    ConversationCaseSpec(
        case_id="collaborative_day_plan_assistant",
        title="What do you want to do today — collaborative plan, not web lookup",
        behavior_family="casual_conversation",
        turns=("What do you want to do today.",),
        chat_id=88073,
        from_id=99073,
        first_update_id=18073,
        first_message_id=28073,
        required_turn_domains=("opinion_reflection",),
        required_reply_markers=("quick win", "focus"),
        forbidden_reply_markers=(
            "say a bit more about what you want",
            "grounded lookup",
            "retry grounded lookup",
...
ROUTING_MATRIX_CASES: tuple[ConversationCaseSpec, ...] = (
    ...
    ConversationCaseSpec(
        case_id="rm_personality_feedback_voice",
        title="Personality feedback — warm reply, no generic or grounded scaffolding",
        behavior_family="opinion_reflection",
        turns=("We need more of your personality to show.",),
        chat_id=91008,
        from_id=91008,
        first_update_id=191008,
        first_message_id=291008,
        capture_tags=("personality_feedback", "conversational"),
        routing_expected_assistant_route="direct",
        routing_expect_delegate=False,
        required_reply_markers=("warmer", "playful"),
        forbidden_reply_markers=(
    ...
    ConversationCaseSpec(
        case_id="rm_collaborative_day_plan",
        title="Collaborative what-to-do-today — conversational, not lookup",
        behavior_family="casual_conversation",
        turns=("What do you want to do today?",),
        chat_id=91009,
        from_id=91009,
        first_update_id=191009,
        first_message_id=291009,
        capture_tags=("collaborative_day_plan", "conversational"),
        routing_expected_assistant_route="direct",
        routing_expect_delegate=False,
        required_reply_markers=("quick win", "focus"),
        forbidden_reply_markers=(
