...
for f in "$CLI" "$TEST_FILE" "${BASE_DIR}/README.md" "${BASE_DIR}/.env.example" "${BASE_DIR}/requirements-test.txt" "${BASE_DIR}/docs/ANDREA_OPENCLAW_HYBRID_SKILLS.md" "${BASE_DIR}/docs/ANDREA_LOCKSTEP_ARCHITECTURE.md" "${BASE_DIR}/docs/ANDREA_LOCKSTEP_REVIEW_FINDINGS.md" "${BASE_DIR}/docs/ANDREA_TELEGRAM_TRI_LLM_SPRINT.md" "${BASE_DIR}/docs/ANDREA_ALEXA_INTEGRATION.md" "${BASE_DIR}/docs/ANDREA_ALEXA_USER_SETUP.md" "${BASE_DIR}/docs/ALEXA_CLOUD_EDGE_TEMPLATE.md" "${BASE_DIR}/scripts/setup_admin.sh" "${BASE_DIR}/scripts/env_loader.py" "${BASE_DIR}/scripts/cursor_api_common.py" "${BASE_DIR}/scripts/handoff_context.py" "${BASE_DIR}/scripts/exhaustive_feature_check.sh" "${BASE_DIR}/scripts/alexa_edge_lambda.py" "${BASE_DIR}/scripts/andrea_capabilities.py" "${BASE_DIR}/scripts/andrea_doctor_receipt.py" "${BASE_DIR}/scripts/andrea_experience_cycle.py" "${BASE_DIR}/scripts/andrea_reliability_probes.sh" "${BASE_DIR}/scripts/dotenv_set_key.py" "${BASE_DIR}/scripts/openclaw_apply_openai_key.sh" "${BASE_DIR}/scripts/andrea_readiness_grade.py" "${BASE_DIR}/scripts/andrea_security_sanity.sh" "${BASE_DIR}/scripts/andrea_slo_check.sh" "${BASE_DIR}/scripts/andrea_doctor.sh" "${BASE_DIR}/scripts/andrea_model_guard.sh" "${BASE_DIR}/scripts/andrea_openclaw_enforce.sh" "${BASE_DIR}/scripts/andrea_release_gate.sh" "${BASE_DIR}/scripts/andrea_services.sh" "${BASE_DIR}/scripts/andrea_slo_telegram.sh" "${BASE_DIR}/scripts/andrea_slo_telegram_probe.py" "${BASE_DIR}/scripts/andrea_sync_server.py" "${BASE_DIR}/scripts/andrea_sync_health.py" "${BASE_DIR}/scripts/andrea_sync_cursor_report.py" "${BASE_DIR}/scripts/andrea_sync_publish_capabilities.py" "${BASE_DIR}/scripts/andrea_sync_openclaw_hybrid.py" "${BASE_DIR}/scripts/andrea_kill_switch.sh" "${BASE_DIR}/scripts/andrea_lockstep_telegram_e2e.py" "${BASE_DIR}/scripts/andrea_communication_smoke.sh" "${BASE_DIR}/scripts/andrea_full_cycle.sh" "${BASE_DIR}/scripts/andrea_wrap_up_prereqs.sh" "${BASE_DIR}/scripts/macos/install_andrea_launchagents.sh" "${BASE_DIR}/scripts/macos/andrea_launchagent_lib.sh" "${BASE_DIR}/scripts/macos/andrea_openclaw_gateway_refresh.sh" "${BASE_DIR}/scripts/macos/andrea_post_login_bootstrap.sh" "${BASE_DIR}/scripts/macos/com.andrea.andrea-post-login-bootstrap.plist.template" "${BASE_DIR}/scripts/macos/com.andrea.andrea-localtunnel.plist.template" "${BASE_DIR}/scripts/macos/com.andrea.openclaw-gateway-refresh.plist.template"; do
...
bash -n "${BASE_DIR}/scripts/andrea_services.sh"
...
bash -n "${BASE_DIR}/scripts/macos/andrea_launchagent_lib.sh"
bash -n "${BASE_DIR}/scripts/macos/andrea_openclaw_gateway_refresh.sh"
...
python3 -m py_compile "${BASE_DIR}/scripts/andrea_doctor_receipt.py"
...
python3 -m py_compile "${BASE_DIR}/scripts/andrea_experience_cycle.py"
...
python3 -m pytest -q "${BASE_DIR}/tests"
